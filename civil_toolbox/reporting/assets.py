...
DISCLAIMER_TEXT = (
    "Generated by Civil Toolbox. Review and validation by a qualified "
    "professional may be required before use in design or permitting."
)
...
def get_disclaimer_text() -> str:
    """Get the professional-use disclaimer text.
